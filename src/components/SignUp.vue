<template>
  <div class="wrap">
    ...
    <form action="" class="wrap-form" @submit.prevent="login">
        <div class="wrap-form__item">
            <label class="wrap-form__label" for="name">Full name</label>
            <input class="wrap-form__input" id="name" name="name" type="text" v-model="name" @input="isNameTouched = true" :class="{ error: isNameError }">
            <div class="wrap-form__error" v-if="isNameError">Error valid name</div>
        </div>
        <div class="wrap-form__item">
        ...
        <div class="wrap-form__item">
            ...
            <input class="wrap-form__input" type="password" name="password" id="pass" @keyup="repeat_valid" v-model="password" @input="isPasswordTouched = true" :class="{ error: isPasswordError }">
            <div class="wrap-form__error" v-if="isPasswordError">Error valid password</div>
            <span class="wrap-form__faq" v-on:click="bubble">
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M6.13983 0.166666C2.92324 0.166666 0.306499 2.7834 0.306499 6C0.306499 9.2166 2.92324 11.8333 6.13983 11.8333C9.35643 11.8333 11.9732 9.2166 11.9732 6C11.9732 2.7834 9.35643 0.166666 6.13983 0.166666ZM5.89678 9.40278C5.49428 9.40278 5.16761 9.07611 5.16761 8.67361C5.16761 8.27111 5.49428 7.94444 5.89678 7.94444C6.29928 7.94444 6.62594 8.27111 6.62594 8.67361C6.62594 9.07611 6.29928 9.40278 5.89678 9.40278ZM7.9924 5.08951C7.84219 5.33014 7.55685 5.60042 7.13587 5.90083C6.45483 6.40444 6.47331 6.51625 6.47331 6.97222H5.27893C5.27893 6.6159 5.27115 6.34222 5.46365 6.00924C5.58664 5.79583 5.81219 5.56882 6.13983 5.32868C6.5331 5.04771 6.91518 4.77694 6.91518 4.30542C6.91518 3.86354 6.53699 3.70604 6.09511 3.70604C5.64449 3.70604 5.13067 3.85333 4.55365 4.14792L4.06219 3.16111C5.11074 2.5734 6.76546 2.3075 7.67011 3.04396C8.33414 3.585 8.33803 4.53632 7.9924 5.08951Z" fill="#CDCDCD"/>
                </svg>
            </span>
            <span class="wrap-form__message">
                Password must contain 8+ symbols,<br> 1 special and 2 capital letters
            </span>
        ...
        <div class="wrap-form__item">
            <label class="wrap-form__label" for="">Repeat password</label>
            <input class="wrap-form__input" type="password" @input="repeat_valid" name="pass_repeat" id="passr">
            <div class="wrap-form__error" id="repeat-error">Passwords do not match</div>
            <span class="wrap-form__show" v-on:click="show_passr" id="passr_show">
                <svg width="20" class="" height="13" viewBox="0 0 20 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M10.1398 0.333313C5.97316 0.333313 2.41483 2.92498 0.973164 6.58331C2.41483 10.2416 5.97316 12.8333 10.1398 12.8333C14.3065 12.8333 17.8648 10.2416 19.3065 6.58331C17.8648 2.92498 14.3065 0.333313 10.1398 0.333313ZM10.1398 10.75C7.83983 10.75 5.97316 8.88331 5.97316 6.58331C5.97316 4.28331 7.83983 2.41665 10.1398 2.41665C12.4398 2.41665 14.3065 4.28331 14.3065 6.58331C14.3065 8.88331 12.4398 10.75 10.1398 10.75ZM10.1398 4.08331C8.7565 4.08331 7.63983 5.19998 7.63983 6.58331C7.63983 7.96665 8.7565 9.08331 10.1398 9.08331C11.5232 9.08331 12.6398 7.96665 12.6398 6.58331C12.6398 5.19998 11.5232 4.08331 10.1398 4.08331Z" fill="#181C43"/>
                </svg>
            </span>
            <span class="wrap-form__hide" v-on:click="hide_passr"  id="passr_hide">
                <svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M10.1399 3.41668C12.4399 3.41668 14.3065 5.28335 14.3065 7.58335C14.3065 8.00835 14.2232 8.41668 14.1065 8.80001L16.6565 11.35C17.8149 10.325 18.7315 9.04168 19.3065 7.57501C17.8649 3.92501 14.3065 1.33335 10.1399 1.33335C9.08152 1.33335 8.06486 1.50001 7.10652 1.80835L8.91486 3.61668C9.30652 3.50001 9.71486 3.41668 10.1399 3.41668ZM2.39818 0.633337C2.07318 0.958337 2.07318 1.48334 2.39818 1.80834L4.03984 3.45C2.68984 4.525 1.61484 5.94167 0.973175 7.58334C2.41484 11.2417 5.97318 13.8333 10.1398 13.8333C11.4065 13.8333 12.6148 13.5833 13.7315 13.15L15.9982 15.4167C16.3232 15.7417 16.8482 15.7417 17.1732 15.4167C17.4982 15.0917 17.4982 14.5667 17.1732 14.2417L3.58151 0.633337C3.25651 0.308337 2.72318 0.308337 2.39818 0.633337ZM10.1399 11.75C7.83986 11.75 5.97319 9.88334 5.97319 7.58334C5.97319 6.94167 6.12319 6.33334 6.38152 5.8L7.68986 7.10834C7.66486 7.25834 7.63986 7.41667 7.63986 7.58334C7.63986 8.96667 8.75652 10.0833 10.1399 10.0833C10.3065 10.0833 10.4565 10.0583 10.6149 10.025L11.9232 11.3333C11.3815 11.6 10.7815 11.75 10.1399 11.75ZM12.6149 7.30835C12.4899 6.14168 11.5732 5.23335 10.4149 5.10835L12.6149 7.30835Z" fill="#181C43"/>
                </svg>
            </span>
        ...
        <div class="wrap-form__item">
            <input class="wrap-form__submit" type="submit" value="Sign Up" :disabled="!isNameValid || !isEmailValid || !isPasswordValid">
        </div>
    </form>
    <div class="wrap-signin">
        <p class="wrap-signin__txt">Already have an account?</p>
        <router-link class="wrap-signin__link" to="/sign-in">Sign in</router-link>
    </div>  
  </div>
</template>    
...
<script>
import $ from 'jquery';
const nameCheckRegex = new RegExp('((?=.*[a-z])).{3,}');
...
export default {
  ...
  methods: {
    ...
    repeat_valid:function(){
        let pass = $('#pass').val();
        let passr = $('#passr').val();
        let email = $('#email').val();
        let name = $('#name').val();
        if(name == '' || email == '' || passr == '' || pass != passr){
            $('#passr').css("background", "#FF6683");
            $('.wrap-form__submit').attr('disabled', 'disabled');
            $('#repeat-error').show();
        }else{
            $('#passr').css("background", "#F3F3FA");
            $('.wrap-form__submit').removeAttr('disabled', 'disabled');
            $('#repeat-error').hide(); 
        }
    },
    login: function () {
